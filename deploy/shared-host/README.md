...
Generated links prefer `PUBLIC_BASE_URL`, then retain compatibility with
`CONCORDIA_PUBLIC_BASE_URL` and `CONCORDIA_HOSTNAME`; the default is the apex
above.
...
3. Add `CONCORDIA_HOSTNAME=concordiadao.xyz` to the shared proxy environment.
