...
10. Open the SafePay Lite record at
...
- SafePay Lite native-CSPR transfer hash: `dcb35f4295909b1c87d07b7f4d02ab95afef99d2d4cdddee961c8f5ca6d4914c`
...
the archived proof. It is not a live provider service, official x402
settlement, escrow, refund contract, or marketplace.
...
- verifier script
- CSPR.click unsigned receipt intent endpoint
- SafePay Lite recorded browser-wallet/native-CSPR evidence
- CSPR.live comparison for the recorded payment hash
