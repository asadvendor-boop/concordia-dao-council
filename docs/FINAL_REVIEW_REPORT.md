...
- SafePay Lite preserves the recorded native-CSPR payment/report evidence and does not promote it as official x402 or a live provider service.
...
- SafePay Lite is recorded V1 native-CSPR payment/report evidence, not a live
  provider service, official x402 settlement, escrow, refund-contract custody,
  or a marketplace.
