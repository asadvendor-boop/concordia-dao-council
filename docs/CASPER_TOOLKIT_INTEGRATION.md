...
| SafePay Lite | The V1 proof runtime preserves a recorded native-CSPR payment and report relation for `DAO-PROP-6CB25C`. | Historical evidence only under the Concordia apex. Official x402 is not shipped; no external provider, facilitator, escrow, refund, marketplace, or continuous-service claim is made. |
