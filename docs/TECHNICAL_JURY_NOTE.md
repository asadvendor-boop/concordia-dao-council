...
SafePay Lite is limited to recorded V1 native-CSPR payment/report evidence:

- the archive preserves the native-CSPR payment hash;
- the archive preserves its relation to the recorded report hash; and
- the governance proof retains the recorded SafePay result.

This record does not establish a live provider or reputation service, official
x402 settlement, escrow, a refund contract, or a marketplace.
