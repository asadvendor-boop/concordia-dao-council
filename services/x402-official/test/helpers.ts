...
export function makeConfig(overrides: Partial<ServiceConfig> = {}): ServiceConfig {
  return {
    ...
    governanceV3PackageHash: FROZEN.governanceV3PackageHash,
    governanceV3ContractHash: FROZEN.governanceV3ContractHash,
    governanceV3DeploymentDomain: FROZEN.governanceV3DeploymentDomain,
...
export function buildRegistryRecord(
  ...
  return {
    ...
    network: config.network,
    package_hash: config.governanceV3PackageHash,
    contract_hash: config.governanceV3ContractHash,
    deployment_domain: config.governanceV3DeploymentDomain,
