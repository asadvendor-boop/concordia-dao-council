...
AGENT_SKILLS: tuple[AgentSkill, ...] = (
    ...
    _skill(
        "scribe",
        "governance-summary",
        "Archive presentation persona",
        "presentation",
        "Non-reasoning presentation persona",
        "Already sealed governance archive metadata.",
        "Presentation metadata only; no vote, card authority, or execution.",
        "No prompt is run; present already sealed evidence without changing it.",
        "Wells never deliberates, seals, authorizes, or executes transactions.",
        "GovernanceSummary",
        "Presentation-only roster persona; no model call or authority-bearing output.",
        "Post-resolution evidence presentation",
        "Label Wells as presentation-only after the Core/Locke archive boundary.",
    ),
)
